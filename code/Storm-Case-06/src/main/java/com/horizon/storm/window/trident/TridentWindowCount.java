 ...
 */
package com.horizon.storm.window.trident;
...
//			System.out.println("complete emit="+sum);
	...
	public static StormTopology buildTopology() {
		...
		WindowConfig tumblingDurationWindow = TumblingDurationWindow.of(new BaseWindowedBolt.Duration(3,TimeUnit.SECONDS));
