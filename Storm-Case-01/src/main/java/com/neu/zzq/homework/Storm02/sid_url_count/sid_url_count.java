...
public class  sid_url_count{
    ...
    public static class SplitSentence extends BaseBasicBolt {
        ...
        public void execute(Tuple tuple, BasicOutputCollector collector){
            String ss;
            k = Kpi.parse(tuple.getStringByField("line"));
            if (k.getIs_validate() && !k.getRemote_addr().toString().contains("-") && !k.getHttp_referrer().toString().contains("-")) {
                ss = k.getRemote_addr()+"-"+k.getHttp_referrer();
                //System.out.print(ss);
                collector.emit(new Values(ss));
            }
        }
        @Override
        public void declareOutputFields(OutputFieldsDeclarer declarer){
