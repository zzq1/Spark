...
public class TumblingWindowCountTopology {

    private static final Logger LOG = LoggerFactory.getLogger(TumblingWindowCountTopology.class);
    ...
    public static void main(String[] args) throws Exception {
        ...
        builder.setBolt("tumblingsum", new TumblingWindowSumBolt().withTumblingWindow(new Count(3)))
